...
% Comandi personali
%*******************************************************
\newcommand{\myName}{Gabriele Camilli Valentina Dompè Iuri La Rosa Alfonsomarco Marra}                            % autore
\newcommand{\myTitle}{Relazione Lab FNS Misure di radioattività e fluorescenza X con un rivelatore al Germanio ultrapuro}  % titolo
\date{}                                                           % nessuna data
