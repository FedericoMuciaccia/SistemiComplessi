...
% WARNING MI VENGONO COSE ASSURDE DAI CALCOLI, CERCARE DI CAPIRE QUALE SIGMA CI VORREBBE PER AVERE UNA RETE RANDOM CROLLANTE TODO TODO, POSSIBILE RISULTATO GRAVE! TODO
% Con gradi medi abbastanza alti, come quelli delle reti in esame, si può avere una soglia percolativa solo se $\langle k^2 \rangle$ è abbastanza piccolo. Fissato $\langle k \rangle$, ciò può avvenire solo se $\sigma^2$ è molto piccola, così che $\langle k^2 \rangle$
