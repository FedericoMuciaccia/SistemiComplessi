...
\begin{figure}[t!]
	\centering
	\includegraphics[width=0.5\textwidth]{./Immagini/Teoria/zoomring}
...
\begin{figure}[t!]
	\centering
	\subfloat[$p = 0$]
	{\includegraphics[width=0.4\textwidth]{./Immagini/Teoria/ringnet}}
	$\;$
	\subfloat[$p = 0.03$]
	{\includegraphics[width=0.4\textwidth]{./Immagini/Teoria/smallworld}}
	\\
	\subfloat[$p = 0.3$]
	{\includegraphics[width=0.4\textwidth]{./Immagini/Teoria/random-smallworld}}
	$\;$
	\subfloat[$p = 1$]
	{\includegraphics[width=0.4\textwidth]{./Immagini/Teoria/totalrandomwatts}}
