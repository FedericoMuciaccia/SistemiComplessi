...
//////////////////////////////////////////////////////////////////////////
	...
	grafico->GetYaxis()->SetNdivisions(5,2,0,kTRUE);
	grafico->GetXaxis()->SetNdivisions(10,3,0,kTRUE);
	
	axis->SetLimits(0,1.02);
	grafico->GetHistogram()->SetMaximum(0.8);         
	...
	TF1 *curva = new TF1("curva", "0.75*(1-x)**3", -0.1, 2);	// definisco funzione di fitting: retta
